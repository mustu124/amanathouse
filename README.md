...
| `npm run seed:categories` | Sync the 4 categories to Supabase |
| `npm run seed:hampers` | Seed two placeholder hampers (needs migration `0003_hampers.sql`) |
| `npm run test:hampers` | Offline checks for the hamper pricing engine, server re-pricing and the WhatsApp message |
